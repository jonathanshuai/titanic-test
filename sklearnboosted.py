...
parameters_list = {'max_depth': [3, 5, 7, 9], 'n_estimators': [50, 100, 150, 200], 'min_impurity_decrease': [0.001, 0.01, 0.1, 1, 10]}

clf = GridSearchCV(GradientBoostingClassifier(), parameters_list)
